        ...
        <section className="w-full">
            ...
            <div className="flex gap-3 sm:gap-4 overflow-x-auto pb-2 scrollbar-none">
                {filteredMatches.length === 0 ? (
                    <p className="text-xs text-text-muted">Nenhum jogo agendado para hoje nesta liga.</p>
                ) : (
                    filteredMatches.map(matches => (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between px-1">
                                <div className="flex flex-col items-center gap-1.5 w-14 sm:w-16 text-center">
                                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-red-600/90 text-white font-black text-xs flex items-center justify-center shadow-md">
                                        {matches.homeBadge}
                                    </div>
                                ...
                                <div className="flex flex-col items-center gap-1.5 w-14 sm:w-16 text-center">
                                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-emerald-700/90 text-white font-black text-xs flex items-center justify-center shadow-md">
                                        {matches.awayBadge}
                                    </div>
                                    <span className="text-xs font-semibold text-text-main truncate max-w-full">
                                        {matches.awayTeam}
