                ...
                <div className="p-4 flex flex-col gap-3">
                    ...
                    {news.url && (
                        <a
                            ...
                            className="mt-2 text-center text-xs font-bold bg-[var(--brand)] text-[var(--bg-main)] py-2 px-4 rounded-xl hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                        >
                            Ler matéria completa no portal oficial ↗
                        </a>
                    )}
                </div>
